...
public class EmployeeView implements Observer {
    ...
    DeliveryServiceBLL deliveryService;

    public EmployeeView(DeliveryServiceBLL deliveryService) {
    ...
    public void update(Observable o, Object arg) {
        OrderBLL order = (OrderBLL) arg;
        ArrayList<MenuItemBLL> products = deliveryService.Orders.get(order);
