...
import businessLogicLayer.BaseProductBLL;
...
public class ClientView extends JFrame {
    ...
    List<BaseProductBLL> products = new ArrayList<>();
    BaseProductBLL b = new BaseProductBLL();
    private JTextField textField_8;
    private JTextField textField_9;

    ArrayList<MenuItemBLL> order = new ArrayList<>();

    DeliveryServiceBLL deliveryService = new DeliveryServiceBLL();
    private JTextField textField_2;

    public ClientView(DeliveryServiceBLL deliveryService, UserBLL user) {
        ...
        btnMenu.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                //deliveryService.products = new ArrayList<>(deliveryService.importProducts());
        ...
        btnNewButton_1.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent es) {
                try {
//                    Serializator.serialization(deliveryService);
                    if ( deliveryService.items.size() == 0 ){
                        JOptionPane.showMessageDialog(null, "No products were selected..", null, JOptionPane.INFORMATION_MESSAGE);
                        return;
                    }
                    deliveryService.createOrder(user.getId(), deliveryService.items);
                    JOptionPane.showMessageDialog(null, "Your order was placed!", null, JOptionPane.INFORMATION_MESSAGE);
        ...
        btnNewButton_2.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                List<MenuItemBLL> products = new ArrayList<>();
